      ...
      <div>
        <div className="product-container">
          ...
          <div id="filter-container">
            ...
            <button className="btn btn-dark" onClick={this.myFilter("All")}>
              All
            </button>
            <button className="btn btn-dark" onClick={this.myFilter("gaming")}>
              Gaming
            </button>
            <button className="btn btn-dark" onClick={this.myFilter("studio")}>
              Studio
            </button>
            <button
              className="btn btn-dark"
              onClick={this.myFilter("everyday")}
            >
              Everyday
            </button>
            <h4>Sort By Price: </h4>
